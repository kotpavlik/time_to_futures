...
async function bootstrap() {
  const app = await NestFactory.create(AppModule, {
    cors: {
      origin:
        ['https://localhost:5173/', 'https://time-to-futures.ru.tuna.am', 'https://time-to-futures-tma.vercel.app,https://fpnpmcdn.net/v3/sIr9k1LhQgendgYm1jcc/loader_v3.11.1.js'],
      credentials: true,
